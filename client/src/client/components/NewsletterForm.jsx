...
function FlagStrip({ className = "w-24 h-0.5" }) {
  return (
...
export default function NewsletterForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (existing) {
        setMessage("THIS EMAIL IS ALREADY IN THE TRIBE");
      ...
      setMessage("WELCOME TO THE MANWE TRIBE");
  ...
  return (
    <section
      ...
      style={{
        // Deep forest green — warm, earthy, distinct from the black shop background
        background:
          "linear-gradient(180deg, #0F1A12 0%, #0C1610 50%, #0F1A12 100%)",
      }}
    >
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse at center, rgba(212,101,31,0.04) 0%, transparent 60%)",
        }}
      />
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        ...
        <div className="absolute top-8 left-8 hidden lg:block">
          <ManweSerpentMini size={20} opacity={0.2} />
        </div>
      ...
      <div className="max-w-2xl mx-auto flex flex-col items-center relative z-10">
        ...
        {/* Emblem */}
        <div className="mb-6">
          <ManweSerpentM size={54} opacity={0.95} />
        </div>
        ...
        >
          ...
          <div
            ...
            `}
            style={{
              backgroundColor: "rgba(8, 10, 8, 0.5)",
          ...
          >
            ...
            <input
              ...
              required
              className="flex-1 bg-transparent outline-none text-[#E8E3D8] placeholder:text-[#E8E3D8]/30"
              style={{
                fontFamily: "'Bebas Neue', sans-serif",
                fontSize: "15px",
                letterSpacing: "0.2em",
          ...
          <button
            ...
            disabled={loading}
            className={`
              group relative flex items-center justify-center gap-3 border px-8 py-3 transition-all duration-300
              ${
                loading
                  ? "border-[#2D5A2E]/20 cursor-not-allowed opacity-50"
                  : "border-[#E8E3D8]/40 hover:border-[#E8E3D8] hover:bg-[#E8E3D8]"
              }
            `}
          >
            {/* Corner diamonds */}
            ...
            <span
              className={`transition-colors ${
                loading
                  ? "text-[#E8E3D8]/40"
                  : "text-[#E8E3D8] group-hover:text-[#0F1A12]"
              }`}
              style={{
                fontFamily: "'Bebas Neue', sans-serif",
                fontSize: "15px",
            ...
            {!loading && (
              <span className="text-[#D4651F] group-hover:text-[#0F1A12] transition-colors font-mono text-sm">
                →
              </span>
            )}
          </button>
        ...
        <div className="mt-10 flex items-center gap-4">
          ...
          <span className="font-mono text-[#E8E3D8]/30 text-[9px] tracking-[0.4em]">
            NGR × CIV
          </span>
          <FlagStrip className="w-20 h-0.5" />
        </div>
      ...
      >
        <div
          className={`
            relative flex items-center gap-3 border px-6 py-4 shadow-2xl
            ${
              messageType === "success"
                ? "border-[#2D5A2E]"
                : "border-[#D4651F]"
        ...
        >
          ...
          <span className="absolute -top-1 -left-1">
            <AdinkraDiamond
              size={6}
              fill={messageType === "success" ? "#2D5A2E" : "#D4651F"}
              opacity={0.9}
            />
          </span>
          <span className="absolute -top-1 -right-1">
          ...
          <span
            className={
              messageType === "success" ? "text-[#E8E3D8]" : "text-[#D4651F]"
            }
            style={{
              fontFamily: "'Bebas Neue', sans-serif",
              fontSize: "14px",

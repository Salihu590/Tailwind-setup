...
function ManweGradientText({ fontSize = "32px", letterSpacing = "0.16em" }) {
  return (
    <span
      style={{
...
export default function Header({
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-40 bg-[#080808]/80 backdrop-blur-xl border-b border-white/10">
      ...
      {/* Hide native search X across browsers */}
      <style>{`
      ...
      <div className="lg:hidden flex items-center justify-between h-[72px] px-5 relative z-50">
        ...
        {/* Left — search toggle (hidden when menu is open) */}
        ...
        {/* Center — Beast + gradient MANWE */}
        <Link
          to="/shop"
          aria-label="MANWE Shop"
        ...
        <div className="flex items-center justify-end gap-5 w-20">
          {!menuOpen && (
            ...
            >
              ...
              {cartCount > 0 && (
                <span className="absolute -top-2.5 -right-2.5 min-w-[18px] h-[18px] px-1 flex items-center justify-center bg-[#C4541A] text-[#E8E3D8] text-[10px] font-bold rounded-full">
        ...
        <div className="flex items-center gap-8">
          ...
          {!isProductPage && (
            <div className="group flex items-center gap-2 border-b border-white/20 focus-within:border-[#E8E3D8] transition-colors pb-2 w-56">
              <ManweBeastMini size={14} opacity={0.2} />
              <FiSearch
                size={15}
          ...
          <Link
            to="/shop"
            className="text-[#E8E3D8]/60 hover:text-[#E8E3D8] transition-colors"
            style={{
              fontFamily: "'Bebas Neue', sans-serif",
              fontSize: "18px",
              letterSpacing: "0.18em",
          ...
          <Link
            to="/cart"
            aria-label={`Shopping bag with ${cartCount} items`}
            className="group flex items-center gap-2.5 text-[#E8E3D8]/60 hover:text-[#E8E3D8] transition-colors"
          >
            <div className="relative">
              <FiShoppingBag size={20} />
              {cartCount > 0 && (
                <span className="absolute -top-3 -right-3 min-w-[18px] h-[18px] px-1 rounded-full flex items-center justify-center bg-[#C4541A] text-[#E8E3D8] text-[9px] font-bold">
                  {cartCount > 99 ? "99+" : cartCount}
                </span>
              )}
            </div>
          ...
          {hasItems ? (
            <Link
              ...
              className="group relative flex items-center border border-[#E8E3D8]/30 hover:border-[#E8E3D8] px-6 py-2.5 hover:bg-[#E8E3D8] transition-all duration-300"
              style={{
                fontFamily: "'Bebas Neue', sans-serif",
                fontSize: "17px",
                letterSpacing: "0.18em",
            ...
            <button
              type="button"
              disabled
              aria-label="Cart is empty — add items to checkout"
